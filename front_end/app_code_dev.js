...
var updateView = async (button) => {
    ...
    if (button.dataset.querytype == 'by_level') {
        ...
        api = `http://${url}/api/by_level/${queryvalue}`;
    }
    ...
    if (button.dataset.querytype == 'combined_query') {
        ...
        api = `http://${url}/api/combined_query/${queryName}/${queryLevel}`;
    }
